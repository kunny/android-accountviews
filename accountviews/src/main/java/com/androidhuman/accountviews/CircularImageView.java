 ...
 *
 * You can obtain full description of CC-BY-4.0 at: http://creativecommons.org/licenses/by/4.0/
 */
...
public class CircularImageView extends ImageView {
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (image != null) {
            ...
            canvas.drawCircle(circleCenter + borderWidth,
                    circleCenter + borderWidth, ((canvasSize - (borderWidth * 2)) / 2) - 4.0f, paint);
        }
    }
